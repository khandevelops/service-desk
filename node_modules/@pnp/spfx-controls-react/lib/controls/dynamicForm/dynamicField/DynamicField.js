...
var DynamicField = /** @class */ (function (_super) {
    ...
    function DynamicField(props) {
                ...
                case 'LookupMulti':
                    return React.createElement("div", null,
                        React.createElement("div", { className: styles.titleContainer },
                            React.createElement(Icon, { className: styles.fieldIcon, iconName: "Switch" }),
                            labelEl),
                        React.createElement(ListItemPicker, { disabled: disabled, listId: lookupListID, defaultSelectedItems: defaultValue, columnInternalName: lookupField, className: styles.feildDisplay, enableDefaultSuggestions: true, keyColumnInternalName: 'Id', itemLimit: 100, onSelectedItem: function (newValue) { _this.onChange(newValue); }, context: context }),
                        descriptionEl,
                        errorTextEl);
                case 'Number':
                    return React.createElement("div", null,
        ...
        _this.getRequiredErrorText = function () {
            var changedValue = _this.state.changedValue;
            return (changedValue === undefined || changedValue === '' || _this.isEmptyArray(changedValue)) && _this.props.required ? strings.DynamicFormRequiredErrorMessage : null;
        };
