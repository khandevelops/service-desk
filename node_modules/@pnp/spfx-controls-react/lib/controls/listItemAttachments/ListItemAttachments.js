    ...
    ListItemAttachments.prototype.uploadAttachments = function (itemId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.state.filesToUpload) return [3 /*break*/, 2];
                        return [4 /*yield*/, Promise.all(this.state.filesToUpload.map(function (file) { return _this._spservice.addAttachment(_this.props.listId, itemId, file.name, file, _this.props.webUrl); }))];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    ...
                    this.state.attachments.map(function (file) {
                        ...
                        return (React.createElement("div", { key: fileName, className: styles.documentCardWrapper },
                            React.createElement(TooltipHost, { content: fileName, calloutProps: { gapSpace: 0, isBeakVisible: true }, closeDelay: 200, directionalHint: DirectionalHint.rightCenter },
                                React.createElement(DocumentCard, { onClickHref: !openAttachmentsInNewWindow && "".concat(encodeURIComponent(file.ServerRelativeUrl), "?web=1"), onClick: openAttachmentsInNewWindow && (function () { return window.open("".concat(encodeURIComponent(file.ServerRelativeUrl), "?web=1"), "_blank"); }), className: styles.documentCard },
