...
export declare type FelaRenderer = IRenderer & {
    ...
    _renderStyleToClassNames({ _className, ...style }: ICSSInJSStyle & {
        _className: string;
    }, pseudo?: string, media?: string, support?: string): string;
    styleNodeAttributes: Record<string, string | number | boolean>;
};
export declare type FelaRendererChange = {
...
export declare type FelaRendererParam = Omit<RendererParam, 'direction'> & {
    theme: {
        direction: RendererParam['direction'];
    };
};
