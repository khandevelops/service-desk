...
var rendererConfig = {
  ...
  plugins: [felaDisableAnimationsPlugin,
  // is necessary to prevent accidental style typos
  // from breaking ALL the styles on the page
  felaSanitizeCssPlugin, felaPluginPlaceholderPrefixer(), felaInvokeKeyframesPlugin, felaPluginEmbedded(), felaExpandCssShorthandsPlugin,
  // Heads up!
  // This is required after fela-plugin-prefixer to resolve the array of fallback values prefixer produces.
  felaPluginFallbackValue(), felaPluginRtl()]
};
export function createFelaRenderer(options) {
  if (options === void 0) {
    options = {};
  }
