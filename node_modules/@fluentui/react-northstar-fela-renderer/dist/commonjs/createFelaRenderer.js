...
var rendererConfig = {
  ...
  plugins: [_felaDisableAnimationsPlugin.felaDisableAnimationsPlugin,
  // is necessary to prevent accidental style typos
  // from breaking ALL the styles on the page
  _felaSanitizeCssPlugin.felaSanitizeCssPlugin, (0, _felaPluginPlaceholderPrefixer.default)(), _felaInvokeKeyframesPlugin.felaInvokeKeyframesPlugin, (0, _felaPluginEmbedded.default)(), _felaExpandCssShorthandsPlugin.felaExpandCssShorthandsPlugin,
  // Heads up!
...
function createFelaRenderer(options) {
  ...
  return function () {
    ...
    var Provider = function Provider(props) {
      return /*#__PURE__*/React.createElement(_RendererProvider.RendererProvider, {
