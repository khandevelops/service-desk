...
Object.keys(_checkboxManager).forEach(function (key) {
  ...
  if (key in exports && exports[key] === _checkboxManager[key]) return;
...
Object.keys(_carouselManager).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _carouselManager[key]) return;
...
Object.keys(_dialogManager).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _dialogManager[key]) return;
...
Object.keys(_sliderManager).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (Object.prototype.hasOwnProperty.call(_exportNames, key)) return;
  if (key in exports && exports[key] === _sliderManager[key]) return;
