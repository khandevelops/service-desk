...
function makeThemeFromPartials(originalTheme, partialPalette, partialSemantic) {
    ...
    var variantTheme = (0, theme_1.createTheme)({ palette: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, originalTheme.palette), partialPalette) });
    // Change semantic colors to use updated variant palette values
    variantTheme.semanticColors = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, variantTheme.semanticColors), partialSemantic);
    // Fill in the rest of the theme
    variantTheme = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, originalTheme), { palette: variantTheme.palette, semanticColors: variantTheme.semanticColors });
    return variantTheme;
}
/**
...
function getStrongVariant(theme) {
    ...
    // Create variant palette
    var variantTheme = (0, theme_1.createTheme)({ palette: (0, tslib_1.__assign)((0, tslib_1.__assign)({}, fullTheme.palette), partialPalette) });
    // Change semantic colors to use updated variant palette values
    variantTheme.semanticColors = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, variantTheme.semanticColors), partialSemantic);
    // Fill in the rest of the theme
    variantTheme = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, fullTheme), { palette: variantTheme.palette, semanticColors: variantTheme.semanticColors, isInverted: !fullTheme.isInverted });
    return variantTheme;
}
