...
var utils_1 = require("src/components/Carousel/utils");
...
function renderCarousel(props, attachTo) {
    return utils_2.mountWithProvider(React.createElement(Carousel_1.Carousel, __assign({ items: items, getItemPositionText: function (index, length) { return index + 1 + " of " + length; } }, props)), { attachTo: attachTo });
}
var getItemsContainer = function (wrapper) {
    return utils_2.findIntrinsicElement(wrapper, "." + Carousel_1.carouselSlotClassNames.itemsContainer);
};
var getPaddleNextWrapper = function (wrapper) {
    return utils_2.findIntrinsicElement(wrapper, "." + Carousel_1.carouselSlotClassNames.paddleNext);
};
var getPaddlePreviousWrapper = function (wrapper) {
    return utils_2.findIntrinsicElement(wrapper, "." + Carousel_1.carouselSlotClassNames.paddlePrevious);
};
var getPaginationWrapper = function (wrapper) {
    return utils_2.findIntrinsicElement(wrapper, "." + Carousel_1.carouselSlotClassNames.pagination);
};
var getNavigationNavigationWrapper = function (wrapper) {
    return utils_2.findIntrinsicElement(wrapper, "." + CarouselNavigation_1.carouselNavigationClassName);
};
var getNavigationNavigationItemAtIndexWrapper = function (wrapper, index) {
    return utils_2.findIntrinsicElement(wrapper, "." + CarouselNavigationItem_1.carouselNavigationItemClassName).at(index);
};
var getButtonWrapper = function (wrapper) { return utils_2.findIntrinsicElement(wrapper, "#" + buttonName); };
jest.useFakeTimers();
describe('Carousel', function () {
    ...
    describe('paddle', function () {
        ...
        it('next should be focused on last slide transition if pagination and not circular', function () {
            var _a = utils_2.createTestContainer(), testContainer = _a.testContainer, removeTestContainer = _a.removeTestContainer;
            var wrapper = renderCarousel({ defaultActiveIndex: 1 }, testContainer);
            var paddleNext = getPaddleNextWrapper(wrapper);
        ...
        it('previous should be focused on first slide transition if pagination and not circular', function () {
            var _a = utils_2.createTestContainer(), testContainer = _a.testContainer, removeTestContainer = _a.removeTestContainer;
            var wrapper = renderCarousel({ defaultActiveIndex: 2 }, testContainer);
            var paddleNext = getPaddleNextWrapper(wrapper);
            var paddlePrevios = getPaddlePreviousWrapper(wrapper);
    ...
    describe('navigation', function () {
        ...
        it('should show and focus the appropriate slide when clicked', function () {
            var _a = utils_2.createTestContainer(), testContainer = _a.testContainer, removeTestContainer = _a.removeTestContainer;
            var wrapper = renderCarousel({ navigation: navigation }, testContainer);
    ...
    describe('animation', function () {
        var animationEnterFromPrev = 'animationEnterFromPrev';
        var animationEnterFromNext = 'animationEnterFromNext';
        var animationExitToPrev = 'animationExitToPrev';
        var animationExitToNext = 'animationExitToNext';
        it('should return animation for exiting left when item is not active', function () {
            expect(utils_1.getAnimationName({
                active: false,
                dir: 'start',
        ...
        it('should return animation for exiting right when item is not active', function () {
            expect(utils_1.getAnimationName({
                active: false,
                dir: 'end',
                animationEnterFromPrev: animationEnterFromPrev,
        ...
        it('should return animation for enter from left when item is active', function () {
            expect(utils_1.getAnimationName({
                active: true,
                dir: 'end',
                animationEnterFromPrev: animationEnterFromPrev,
        ...
        it('should return animation for enter from right when item is active', function () {
            expect(utils_1.getAnimationName({
                active: true,
                dir: 'start',
                animationEnterFromPrev: animationEnterFromPrev,
    ...
    describe('focus zone "visible" attribute', function () {
        it('should has data-is-visible=false when previous paddle is hidden', function () {
            var wrapper = renderCarousel({ defaultActiveIndex: 0 });
            var paddlePrevios = getPaddlePreviousWrapper(wrapper).getDOMNode();
            var paddleNext = getPaddleNextWrapper(wrapper).getDOMNode();
        ...
        it('should has data-is-visible=false when next paddle is hidden', function () {
            var wrapper = renderCarousel({ defaultActiveIndex: 3 });
            var paddleNext = getPaddleNextWrapper(wrapper).getDOMNode();
            var paddlePrevios = getPaddlePreviousWrapper(wrapper).getDOMNode();
