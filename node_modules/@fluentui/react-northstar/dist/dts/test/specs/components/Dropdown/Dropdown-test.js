...
describe('Dropdown', function () {
    ...
    describe('clearable', function () {
        ...
        it('is not visible when an empty array is passed', function () {
            var getClearIndicatorWrapper = test_utils_2.renderDropdown({
                clearable: true,
                multiple: true,
                value: [],
        ...
        it('is not visible when an empty string is passed', function () {
            var getClearIndicatorWrapper = test_utils_2.renderDropdown({
                clearable: true,
                value: '',
            }).getClearIndicatorWrapper;
    ...
    describe('allowFreeForm', function () {
        ['Enter', 'Tab'].forEach(function (key) {
            it("selects item that starts with query prefix on " + key, function () {
                var _a = test_utils_2.renderDropdown({
                    search: function (items) { return items; },
                    allowFreeform: true,
                }), changeSearchInput = _a.changeSearchInput, keyDownOnSearchInput = _a.keyDownOnSearchInput, searchInputNode = _a.searchInputNode;
                changeSearchInput('it');
                expect(searchInputNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_2.getItemIdRegexByIndex(0)));
            ...
            it("highlights first item matching prefix and selects it on " + key, function () {
                var items = ['item0', 'item1', 'itemA1', 'itemB1'];
                var _a = test_utils_2.renderDropdown({
                    search: function (items) { return items; },
                    allowFreeform: true,
                    items: items,
                ...
                expect(searchInputNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_2.getItemIdRegexByIndex(2)));
                keyDownOnSearchInput(key);
                expect(searchInputNode).toHaveValue('itemA1');
            });
            it("keeps search query value when there is no match on " + key, function () {
                var _a = test_utils_2.renderDropdown({
                    search: function (items) { return items; },
                    allowFreeform: true,
                }), changeSearchInput = _a.changeSearchInput, keyDownOnSearchInput = _a.keyDownOnSearchInput, searchInputNode = _a.searchInputNode;
            ...
            it("keeps search query value when when selected by arrow key on " + key, function () {
                var _a = test_utils_2.renderDropdown({
                    search: function (items) { return items; },
                    allowFreeform: true,
                }), changeSearchInput = _a.changeSearchInput, keyDownOnSearchInput = _a.keyDownOnSearchInput, searchInputNode = _a.searchInputNode;
        ...
        it('selects item that starts with query prefix when user clicks on toggle', function () {
            var _a = test_utils_2.renderDropdown({
                search: function (items) { return items; },
                allowFreeform: true,
            }), clickOnToggleIndicator = _a.clickOnToggleIndicator, changeSearchInput = _a.changeSearchInput, searchInputNode = _a.searchInputNode;
            changeSearchInput('it');
            expect(searchInputNode).toHaveAttribute('aria-activedescendant', expect.stringMatching(test_utils_2.getItemIdRegexByIndex(0)));
            clickOnToggleIndicator();
            expect(searchInputNode).toHaveValue('item0');
    ...
    describe('multiple', function () {
        ...
        it('should not call onRemove when dropdown is disabled', function () {
            var onRemove = jest.fn();
            var value = { header: test_utils_2.items[0], onRemove: onRemove };
            var clickOnSelectedItemAtIndex = test_utils_2.renderDropdown({ multiple: true, value: value, disabled: true }).clickOnSelectedItemAtIndex;
            clickOnSelectedItemAtIndex(0);
    ...
    describe('accessibility trigger button aria labels', function () {
        ...
        it('trigger button should have aria-labelledby which points to trigger button content', function () {
            var triggerButtonNode = test_utils_2.renderDropdown({ items: test_utils_2.items }).triggerButtonNode;
        ...
        it('trigger button merges props correctly', function () {
            var triggerButtonNode = test_utils_2.renderDropdown({ items: test_utils_2.items, triggerButton: { 'data-test': 'ok' } }).triggerButtonNode;
            expect(triggerButtonNode.firstChild).toHaveAttribute('id');
            var contentId = triggerButtonNode.firstElementChild.getAttribute('id');
            expect(triggerButtonNode).toHaveAttribute('aria-labelledby');
        ...
        it('trigger button merges props correctly when content is string', function () {
            var triggerButtonNode = test_utils_2.renderDropdown({ items: test_utils_2.items, triggerButton: { content: 'ok' } }).triggerButtonNode;
            expect(triggerButtonNode.firstChild).toHaveAttribute('id');
            var contentId = triggerButtonNode.firstElementChild.getAttribute('id');
            expect(triggerButtonNode).toHaveAttribute('aria-labelledby');
            expect(triggerButtonNode.getAttribute('aria-labelledby')).toContain(contentId);
        ...
        it('trigger button merges props correctly when content is object', function () {
            var triggerButtonNode = test_utils_2.renderDropdown({
                items: test_utils_2.items,
