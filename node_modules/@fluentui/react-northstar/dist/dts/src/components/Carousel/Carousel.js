...
exports.Carousel = React.forwardRef(function (props, ref) {
    ...
    var dir = useDirection(activeIndex, circular, items === null || items === void 0 ? void 0 : items.length);
        ...
        return (React.createElement("div", __assign({}, getA11yProps('itemsContainerWrapper', {
            ...
            React.createElement("div", __assign({}, getA11yProps('itemsContainer', {
                ...
                items.map(function (item, index) {
                    ...
                    var animationName = utils_2.getAnimationName({
                        active: active,
                        dir: dir,
                    ...
                    return (React.createElement(Animation_1.Animation, { visible: active, key: item['key'] || index, mountOnEnter: true, unmountOnExit: true, name: animationName },
