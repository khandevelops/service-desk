...
exports.Dialog = React.forwardRef(function (props, ref) {
    ...
    var handleDialogCancel = function (e) {
        _.invoke(props, 'onCancel', e, __assign(__assign({}, props), { open: false }));
        setOpen(false);
    };
    var handleDialogConfirm = function (e) {
        _.invoke(props, 'onConfirm', e, __assign(__assign({}, props), { open: false }));
        setOpen(false);
    };
    var handleDialogOpen = function (e) {
        _.invoke(props, 'onOpen', e, __assign(__assign({}, props), { open: true }));
        setOpen(true);
    };
    ...
    var registerMouseDownOnDialogContent = function (e) {
        if (e.button === 0) {
    ...
    var handleOverlayClick = function (e) {
        ...
        // refs
        var isInsideContentClick = isMouseDownInsideContent.current || utils_1.doesNodeContainClick(contentRef.current, e, context.target);
    ...
    var dialogActions = (cancelElement || confirmElement) &&
        ButtonGroup_1.ButtonGroup.create(actions, {
            ...
            overrideProps: {
                content: (React.createElement(Flex_1.Flex, { gap: "gap.smaller", hAlign: "end" },
                    cancelElement,
                    confirmElement)),
            },
        });
    var dialogContent = (React.createElement(react_component_ref_1.Ref, { innerRef: contentRef },
        React.createElement(ElementType, __assign({}, getA11yProps('popup', __assign(__assign({ className: classes.root, ref: ref }, unhandledProps), { onMouseDown: registerMouseDownOnDialogContent }))),
...
exports.Dialog.propTypes = __assign(__assign({}, utils_1.commonPropTypes.createCommon({
    children: false,
    content: 'shorthand',
