...
exports.Loader = React.forwardRef(function (props, ref) {
    ...
    setStart();
    var delay = props.delay, secondary = props.secondary, label = props.label, indicator = props.indicator, inline = props.inline, labelPosition = props.labelPosition, className = props.className, design = props.design, styles = props.styles, variables = props.variables, size = props.size;
    ...
    var svgElement = (React.createElement("svg", { viewBox: "0 0 100 100", xmlns: "http://www.w3.org/2000/svg", className: classes.svg },
        React.createElement("circle", { className: classes.svgTrack }),
        React.createElement("circle", { className: classes.svgTail })));
    var element = visible && (React.createElement(ElementType, __assign({}, getA11yProps('root', __assign({ className: classes.root, ref: ref }, unhandledProps))),
...
exports.Loader.propTypes = __assign(__assign({}, utils_1.commonPropTypes.createCommon({
    children: false,
    content: false,
})), { delay: PropTypes.number, indicator: customPropTypes.itemShorthand, inline: PropTypes.bool, label: customPropTypes.itemShorthand, labelPosition: PropTypes.oneOf(['above', 'below', 'start', 'end']), size: customPropTypes.size, svg: customPropTypes.itemShorthand, secondary: PropTypes.bool });
