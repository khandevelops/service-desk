...
exports.Pill = React.forwardRef(function (props, ref) {
    ...
    var element = getA11yProps.unstable_wrapWithFocusZone(React.createElement(ElementType, __assign({}, getA11yProps('root', __assign(__assign({ className: classes.root, ref: ref }, ((actionable || selectable) && { onClick: handleClick })), unhandledProps))),
        selectable &&
            selected &&
...
exports.Pill.defaultProps = {
    as: 'span',
    accessibility: accessibility_1.pillBehavior,
};
