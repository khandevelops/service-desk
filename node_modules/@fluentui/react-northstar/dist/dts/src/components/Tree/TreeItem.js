 ...
 */
exports.TreeItem = React.forwardRef(function (props, ref) {
    ...
    var elementRef = React.useCallback(function (node) {
    ...
    var element = (React.createElement(ElementType, __assign({}, getA11Props('root', __assign(__assign({ className: classes.root, id: id, ref: elementRef, selected: selected === true, onClick: handleClick, onKeyDown: handleKeyDown }, utils_1.rtlTextContainer.getAttributes({ forElements: [children] })), unhandledProps))), utils_1.childrenExist(children)
        ? children
        : TreeTitle_1.TreeTitle.create(title, {
            defaultProps: function () {
                return getA11Props('title', __assign(__assign({ hasSubtree: hasSubtree, as: hasSubtree ? 'span' : 'a', level: level, treeSize: treeSize, expanded: expanded, index: index, selected: selected === true, selectable: selectable, parent: parent }, (hasSubtree && {
                    indeterminate: selected === 'indeterminate',
...
exports.TreeItem.propTypes = __assign(__assign({}, utils_1.commonPropTypes.createCommon({
    content: false,
