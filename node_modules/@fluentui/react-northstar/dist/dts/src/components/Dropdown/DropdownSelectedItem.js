 ...
 */
exports.DropdownSelectedItem = React.forwardRef(function (props, ref) {
    ...
    setStart();
    var active = props.active, header = props.header, icon = props.icon, image = props.image, className = props.className, design = props.design, styles = props.styles, variables = props.variables, disabled = props.disabled;
    ...
    var handleIconOverrides = function (iconProps) { return (__assign(__assign({}, iconProps), { onClick: function (e, iconProps) {
            if (disabled)
                return;
            e.stopPropagation();
    ...
    var element = (React.createElement(react_component_ref_1.Ref, { innerRef: itemRef },
        React.createElement(ElementType, __assign({}, getA11yProps('root', __assign({ className: classes.root, onClick: handleClick, onKeyDown: handleKeyDown, ref: ref }, unhandledProps))),
            imageElement,
            headerElement,
            iconElement)));
    setEnd();
...
exports.DropdownSelectedItem.propTypes = __assign(__assign({}, utils_1.commonPropTypes.createCommon({
    children: false,
