...
exports.Dropdown = React.forwardRef(function (props, ref) {
    ...
    var renderTriggerButton = function (getToggleButtonProps) {
        ...
        var triggerButtonProps = getToggleButtonProps(__assign({ disabled: disabled, onFocus: handleTriggerButtonOrListFocus, onBlur: handleTriggerButtonBlur, onKeyDown: function (e) {
            ...
            }, 'aria-invalid': ariaInvalid, 'aria-label': undefined, 'aria-labelledby': [ariaLabelledby, triggerButtonContentId].filter(Boolean).join(' ') }, (open && { 'aria-expanded': true })));
        ...
        return (React.createElement(react_component_ref_1.Ref, { innerRef: buttonRef }, utils_1.createShorthand(Button_1.Button, triggerButton, {
            defaultProps: function () { return (__assign({ className: exports.dropdownSlotClassNames.triggerButton, disabled: disabled, id: triggerButtonId, fluid: true, styles: resolvedStyles.triggerButton }, restTriggerButtonProps)); },
            overrideProps: function (predefinedProps) {
                // It can be a shorthand
                var resolvedContent = _.isPlainObject(predefinedProps.content)
                ...
                return {
                    ...
                    predefinedProps.content === null ? null : __assign({ content: content, id: triggerButtonContentId }, resolvedContent),
                    onClick: function (e) {
                        onClick(e);
    ...
    var renderSearchInput = function (accessibilityComboboxProps, highlightedIndex, getInputProps, selectItemAtIndex, toggleMenu, variables) {
        var noPlaceholder = (searchQuery === null || searchQuery === void 0 ? void 0 : searchQuery.length) > 0 || (multiple && value.length > 0);
    ...
    var renderSelectedItems = function () {
        ...
        var selectedItems = value.map(function (item, index) {
            ...
            return DropdownSelectedItem_1.DropdownSelectedItem.create(item, {
                defaultProps: function () { return (__assign({ className: exports.dropdownSlotClassNames.selectedItem, active: isSelectedItemActive(index), disabled: disabled, variables: variables }, (typeof item === 'object' &&
                    !item.hasOwnProperty('key') && {
                    key: item.header,
                }))); },
        ...
        switch (type) {
            case downshift_1.default.stateChangeTypes.changeInput: {
                ...
                if (allowFreeform) {
                    ...
                    var itemIndex = items.findIndex(function (i) { var _a, _b; return (_a = itemToString(i)) === null || _a === void 0 ? void 0 : _a.toLocaleLowerCase().startsWith((_b = changes.inputValue) === null || _b === void 0 ? void 0 : _b.toLowerCase()); });
                    if (itemIndex !== -1) {
            ...
            case downshift_1.default.stateChangeTypes.clickItem:
                ...
                if (allowFreeform && !inListbox.current && type === downshift_1.default.stateChangeTypes.keyDownEnter) {
                    var itemIndex = items.findIndex(function (i) { var _a; return (_a = itemToString(i)) === null || _a === void 0 ? void 0 : _a.toLocaleLowerCase().startsWith(searchQuery === null || searchQuery === void 0 ? void 0 : searchQuery.toLocaleLowerCase()); });
            ...
            case downshift_1.default.stateChangeTypes.mouseUp:
                if (open) {
                    newState.open = false;
                    if (allowFreeform) {
                        var itemIndex = items.findIndex(function (i) { var _a; return (_a = itemToString(i)) === null || _a === void 0 ? void 0 : _a.toLowerCase().startsWith(searchQuery === null || searchQuery === void 0 ? void 0 : searchQuery.toLowerCase()); });
                        // if there is an item that starts with searchQuery, still apply the search query
                        // to do auto complete (you enter '12:', can be completed to '12:00')
                        if (itemIndex !== -1) {
            ...
            case downshift_1.default.stateChangeTypes.keyDownSpaceButton:
                ...
                if (changes.isOpen) {
                    ...
                    var itemIndex = items.findIndex(function (i) { var _a; return (_a = itemToString(i)) === null || _a === void 0 ? void 0 : _a.toLocaleLowerCase().startsWith(searchQuery.toLowerCase()); });
                    // if there is an item that starts with searchQuery, still apply the search query
                    // to do auto complete (you enter '12:', can be completed to '12:00')
                    if (itemIndex !== -1) {
                        newState.searchQuery = itemToString(items[itemIndex]);
                    ...
                    case accessibility_1.keyboardKey.ArrowLeft:
                        ...
                        if (!context.rtl) {
                            ...
                            if (process.env.NODE_ENV !== 'test') {
                                utils_1.setWhatInputSource(e.view.document, 'keyboard');
                            }
