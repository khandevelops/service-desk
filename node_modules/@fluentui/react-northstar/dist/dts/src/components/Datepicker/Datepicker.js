...
var formatRestrictedInput = function (restrictedOptions, localizationStrings) {
    ...
    if (!!restrictedOptions.minDate && !!restrictedOptions.maxDate) {
        formattedString = utils_1.format(localizationStrings.inputBoundedFormatString, localizationStrings.formatMonthDayYear(restrictedOptions.minDate, localizationStrings), localizationStrings.formatMonthDayYear(restrictedOptions.maxDate, localizationStrings));
    }
    else if (!!restrictedOptions.minDate) {
        formattedString = utils_1.format(localizationStrings.inputMinBoundedFormatString, localizationStrings.formatMonthDayYear(restrictedOptions.minDate, localizationStrings));
    }
    else if (!!restrictedOptions.maxDate) {
        formattedString = utils_1.format(localizationStrings.inputMaxBoundedFormatString, localizationStrings.formatMonthDayYear(restrictedOptions.maxDate, localizationStrings));
    }
    else {
