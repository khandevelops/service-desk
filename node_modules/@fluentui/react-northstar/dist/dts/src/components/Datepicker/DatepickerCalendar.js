 ...
 */
exports.DatepickerCalendar = React.forwardRef(function (props, ref) {
    ...
    var renderCellButton = function (day, dateRange) {
        return utils_1.createShorthand(DatepickerCalendarCellButton_1.DatepickerCalendarCellButton, calendarCellButton, {
            ...
            overrideProps: function (predefinedProps) { return ({
                ...
                onClick: function (e) {
                    _.invoke(props, 'onDateChange', e, __assign(__assign({}, props), { value: day, selectedDateRange: dateRangeType !== date_time_utilities_1.DateRangeType.Day ? dateRange : [day] }));
