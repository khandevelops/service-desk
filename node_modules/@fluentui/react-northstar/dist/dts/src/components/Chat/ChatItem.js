 ...
 */
exports.ChatItem = React.forwardRef(function (inputProps, ref) {
    ...
    var props = __assign(__assign({}, chatProps), inputProps);
    var accessibility = props.accessibility, attached = props.attached, children = props.children, className = props.className, contentPosition = props.contentPosition, density = props.density, design = props.design, gutter = props.gutter, message = props.message, styles = props.styles, variables = props.variables, _b = props.unstable_layout, layout = _b === void 0 ? 'default' : _b;
    ...
    var element = (React.createElement(ElementType, __assign({}, getA11Props('root', __assign(__assign({ className: classes.root, ref: ref }, utils_1.rtlTextContainer.getAttributes({ forElements: [children] })), unhandledProps))), utils_1.childrenExist(children) ? children : renderContent()));
    setEnd();
    return element;
});
...
exports.ChatItem.propTypes = __assign(__assign({}, utils_1.commonPropTypes.createCommon({ content: false })), { attached: PropTypes.oneOfType([PropTypes.bool, PropTypes.oneOf(['top', 'bottom'])]), contentPosition: PropTypes.oneOf(['start', 'end']), density: PropTypes.oneOf(['comfy', 'compact']), gutter: customPropTypes.itemShorthand, message: customPropTypes.itemShorthand, unstable_layout: PropTypes.oneOf(['default', 'refresh']) });
