...
var ChatMessageContent_1 = require("./ChatMessageContent");
...
exports.chatMessageSlotClassNames = {
    ...
    body: exports.chatMessageClassName + "__body",
    bubble: exports.chatMessageClassName + "__bubble",
    bubbleInset: exports.chatMessageClassName + "__bubble-inset",
...
exports.ChatMessage = React.forwardRef(function (inputProps, ref) {
    ...
    var accessibility = props.accessibility, _b = props.attached, attached = _b === void 0 ? parentAttached : _b, author = props.author, badge = props.badge, badgePosition = props.badgePosition, children = props.children, className = props.className, compactBody = props.compactBody, content = props.content, density = props.density, design = props.design, details = props.details, header = props.header, mine = props.mine, positionActionMenu = props.positionActionMenu, reactionGroup = props.reactionGroup, reactionGroupPosition = props.reactionGroupPosition, readStatus = props.readStatus, styles = props.styles, timestamp = props.timestamp, overflow = props.unstable_overflow, _c = props.unstable_layout, layout = _c === void 0 ? 'default' : _c, variables = props.variables, failed = props.failed, bubble = props.bubble, body = props.body, bubbleInset = props.bubbleInset, bubbleInsetContent = props.bubbleInsetContent, headerContent = props.headerContent;
    ...
    var messageContent = utils_1.createShorthand(ChatMessageContent_1.ChatMessageContent, content, {
        defaultProps: function () { return ({ badgePosition: badgePosition, density: density, failed: failed, hasBadge: !!badge, mine: mine, unstable_layout: layout }); },
    ...
    if (density === 'compact') {
        ...
        var bubbleElement_1 = Box_1.Box.create(bubble || {}, {
            defaultProps: function () {
                return getA11Props('bubble', {
                    className: exports.chatMessageSlotClassNames.bubble,
        ...
        var bubbleInsetElement_1 = Box_1.Box.create(bubbleInset || {}, {
            defaultProps: function () { return ({
                as: 'span',
                className: exports.chatMessageSlotClassNames.bubbleInset,
        ...
        var bodyElement = Box_1.Box.create(body || {}, {
            defaultProps: function () {
                return getA11Props('body', {
                    className: exports.chatMessageSlotClassNames.body,
