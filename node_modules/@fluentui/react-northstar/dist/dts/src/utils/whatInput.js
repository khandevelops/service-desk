...
var currentInput = 'mouse'; // assume happy path
// event buffer timer
var eventTimer = null;
 ...
 */
var keyboardInputFocused = function (document, eventKey) {
...
var setInput = function (event) {
    ...
    if (!isBuffering) {
        ...
        var shouldUpdate = (value === 'keyboard' && eventKey && ignoreMatch && keyboardInputFocused(event.view.document, eventKey)) ||
            value === 'mouse' ||
            value === 'touch';
