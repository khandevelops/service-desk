...
exports.tooltipContentStyles = {
    ...
    pointer: function (_a) {
        ...
        return (__assign({ display: 'block', position: 'absolute', width: v.pointerWidth, height: v.pointerHeight }, getPointerStyles_1.getPointerStyles({
            ...
            placement: p.basePlacement,
            rtl: rtl,
            svg: v.svgPointer ? pointerSvgUrl_1.pointerSvgUrl(p.subtle ? v.subtleBackgroundColor : v.backgroundColor) : undefined,
        })));
    },
    content: function (_a) {
        var p = _a.props, v = _a.variables;
        return (__assign(__assign({ display: 'block', fontSize: utils_1.pxToRem(12), padding: v.padding, textAlign: 'left', lineHeight: utils_1.pxToRem(16), color: v.color, background: v.backgroundColor, borderRadius: v.borderRadius, borderStyle: v.borderStyle, borderColor: v.borderColor, boxShadow: v.boxShadow }, (p.subtle && {
