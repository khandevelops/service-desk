...
exports.avatarVariables = exports.labelColorAreas = void 0;
var utils_1 = require("../../../../utils");
exports.labelColorAreas = utils_1.stringLiteralsArray('foreground', 'background');
var avatarVariables = function (siteVariables) { return ({
    avatarBorderColor: '',
    avatarBorderWidth: '0',
    ...
    imageAvatarRadius: utils_1.pxToRem(9999),
    imageAvatarSize: utils_1.pxToRem(32),
    imageCircularRadius: utils_1.pxToRem(9999),
    labelCircularRadius: utils_1.pxToRem(9999),
    labelColor: 'rgba(0, 0, 0, 0.6)',
    labelBackground: 'rgb(232, 232, 232)',
}); };
exports.avatarVariables = avatarVariables;
