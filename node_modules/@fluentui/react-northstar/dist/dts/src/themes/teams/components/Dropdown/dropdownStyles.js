...
var createTransparentColorStyleObj = function () { return (__assign(__assign({}, transparentColorStyle), { ':hover': __assign({}, transparentColorStyle), ':active': __assign({}, transparentColorStyle), ':focus': __assign(__assign({}, transparentColorStyle), { ':active': __assign({}, transparentColorStyle) }) })); };
...
exports.dropdownStyles = {
    ...
    container: function (_a) {
        ...
        return (__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({ display: 'flex', flexWrap: 'wrap', position: 'relative', borderStyle: 'solid', borderColor: v.borderColor, outline: 0, width: getWidth(p, v), borderWidth: p.search ? "0 0 " + v.searchBorderBottomWidth + " 0" : v.borderWidth, color: v.color, backgroundColor: v.backgroundColor, borderRadius: v.containerBorderRadius }, (p.open && p.position === 'above' && { borderRadius: v.openAboveContainerBorderRadius })), (p.open && p.position === 'below' && { borderRadius: v.openBelowContainerBorderRadius })), { ':hover': __assign({ backgroundColor: v.backgroundColorHover, borderColor: v.borderColorHover }, (p.open && {
            ...
            } }), (p.focused && __assign(__assign({ backgroundColor: v.backgroundColor }, (p.search && {
            borderBottomColor: v.borderColorFocus,
        })), (!p.search &&
            !p.open &&
            p.isFromKeyboard &&
            getBorderFocusStyles_1.getBorderFocusStyles({ variables: siteVariables })[':focus-visible'])))), (p.inline && __assign(__assign({}, createTransparentColorStyleObj()), { alignItems: 'center' }))), (p.inverted && {
        ...
        })), (_b = {}, _b["& ." + Dropdown_1.dropdownSlotClassNames.triggerButton] = __assign({}, (p.disabled && {
            color: siteVariables.colorScheme.default.foregroundDisabled,
        })), _b)));
    },
    selectedItems: function (_a) {
        var p = _a.props, v = _a.variables;
        return (__assign(__assign({ display: 'flex', flexWrap: 'wrap', overflowY: 'auto', overflowX: 'hidden', maxHeight: v.selectedItemsMaxHeight, width: '100%' }, (p.hasToggleIndicator && { paddingRight: v.toggleIndicatorSize })), (p.multiple &&
            p.hasItemsSelected && {
    ...
    triggerButton: function (_a) {
        var p = _a.props, v = _a.variables;
        return __assign(__assign(__assign(__assign(__assign(__assign({ overflow: 'hidden', boxShadow: 'none', minHeight: utils_1.pxToRem(32) }, createTransparentColorStyleObj()), { margin: '0', justifyContent: 'left', padding: v.comboboxPaddingButton }), (p.multiple && __assign({ minWidth: 0, flex: 1 }, (p.hasItemsSelected && {
            position: 'absolute',
            top: 0,
            right: 0,
            left: 0,
            bottom: 0,
            height: '100%',
        })))), createTransparentColorStyleObj()), { ':focus': __assign({ color: v.color }, createTransparentColorStyleObj()), ':focus-visible': __assign(__assign({ color: v.color }, transparentColorStyle), { ':after': {
                    borderColor: 'transparent',
                    borderRightWidth: 0,
                }, ':before': {
                    borderColor: 'transparent',
                    borderRightWidth: 0,
                } }), ':active': __assign(__assign({ color: v.color }, transparentColorStyle), { animationName: 'unset', animationDuration: 'unset' }), ':hover': __assign(__assign({}, transparentColorStyle), { color: v.color }) }), (p.inline && {
            paddingLeft: 0,
            paddingRight: 0,
            width: 'initial',
        }));
    ...
    toggleIndicator: function (_a) {
        var p = _a.props, v = _a.variables;
        return (__assign(__assign(__assign(__assign(__assign({ alignItems: 'center', display: 'flex', justifyContent: 'center', alignSelf: 'center', cursor: 'pointer' }, (p.disabled && {
            cursor: 'default',
