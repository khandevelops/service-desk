...
var getBorderFocusStyles = function (args) {
    ...
    return {
        ...
        ':focus-visible': {
            ...
            ':after': __assign(__assign({}, defaultPreudoStyles), { borderWidth: focusOuterBorderWidth, zIndex: zIndex, borderColor: focusOuterBorderColor, top: borderPadding == null
