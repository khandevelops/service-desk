...
exports.chatMessageStylesComfy = {
    root: function (_a) {
        var _b, _c, _d, _e;
        var p = _a.props, v = _a.variables;
        return (__assign(__assign(__assign(__assign({ marginLeft: p.mine ? v.offset : 0, marginRight: !p.mine ? v.offset : 0, maxWidth: "calc(100% - " + v.offset + ")", minWidth: v.offset, paddingLeft: v.padding, paddingRight: v.padding, paddingTop: utils_1.pxToRem(8), paddingBottom: utils_1.pxToRem(10), backgroundColor: p.mine ? v.backgroundColorMine : v.backgroundColor, border: v.border }, ((v.hasMention || v.isImportant) && (_b = {},
    ...
    author: function (_a) {
        var p = _a.props, v = _a.variables;
        return (__assign(__assign({}, ((p.mine || p.attached === 'bottom' || p.attached === true) && accessibilityStyles_1.screenReaderContainerStyles)), { color: v.authorColor, fontWeight: v.authorFontWeight, marginRight: v.authorMarginRight, marginBottom: v.headerMarginBottom }));
    },
    badge: function (_a) {
        var _b;
        var p = _a.props;
        return (_b = {},
            _b[p.badgePosition === 'start' ? 'left' : 'right'] = 0,
            _b.transform = p.badgePosition === 'start' ? 'translateX(-50%)' : 'translateX(50%)',
            _b.top = utils_1.pxToRem(4),
            _b.position = 'absolute',
            _b);
    },
    reactionGroup: function (_a) {
        var p = _a.props, v = _a.variables;
        return (__assign(__assign({ marginLeft: v.reactionGroupMarginLeft }, (p.hasBadge && p.badgePosition === 'end' && { marginRight: utils_1.pxToRem(2) })), { float: 'right' }));
    },
    timestamp: function (_a) {
        var p = _a.props, v = _a.variables;
        return (__assign({ marginBottom: v.headerMarginBottom }, ((p.attached === 'bottom' || p.attached === true) &&
