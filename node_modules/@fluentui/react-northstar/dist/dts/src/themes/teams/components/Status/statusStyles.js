...
exports.statusStyles = {
    root: function (_a) {
        ...
        return __assign(__assign(__assign(__assign({ display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }, exports.getSizeStyles(sizeToPxValue[size], variables)), { verticalAlign: 'middle', borderRadius: '9999px' }), (variables.borderColor && {
    ...
    icon: function (_a) {
        var _b = _a.props, size = _b.size, state = _b.state, v = _a.variables;
        return ({
            display: 'inline-flex',
            alignItems: 'center',
            justifyContent: 'center',
            width: utils_1.pxToRem(iconSizeToPxValue[size]),
            height: utils_1.pxToRem(iconSizeToPxValue[size]),
