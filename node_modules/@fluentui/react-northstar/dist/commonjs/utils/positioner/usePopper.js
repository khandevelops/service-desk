...
var _isIntersectingModifier = require("./isIntersectingModifier");
...
function usePopperOptions(options, popperOriginalPositionRef) {
  ...
  return React.useCallback(function (target, container, arrow) {
    ...
    var modifiers = [_isIntersectingModifier.isIntersectingModifier,
    /**
  ...
  }, [autoSize, flipBoundary, offsetModifier, overflowBoundary, placement, strategy, unstable_disableTether, unstable_pinned, userModifiers,
