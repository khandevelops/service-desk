...
exports.mergeProviderContexts = exports.mergePerformanceOptions = exports.mergeBooleanValues = exports.getRenderer = void 0;
...
var mergeProviderContexts = function mergeProviderContexts(createRenderer) {
  ...
  return contexts.reduce(function (acc, next) {
    if (!next) return acc;
    acc.theme = (0, _styles.mergeThemes)(acc.theme, next.theme);
