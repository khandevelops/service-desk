...
exports.reactionVariables = void 0;
var _utils = require("../../../../utils");
var reactionVariables = function reactionVariables(siteVars) {
  return {
    ...
    outlineWidthFocus: (0, _utils.pxToRem)(2),
    outlineOffsetFocus: (0, _utils.pxToRem)(-2),
    meReacting: false,
    boxShadowColor: siteVars.colors.white,
    borderColorFocus: siteVars.colors.grey[750]
  };
};
exports.reactionVariables = reactionVariables;
