define(["require", "exports", "tslib", "react", "@fluentui/merge-styles", "@fluentui/style-utilities", "@fluentui/utilities", "../slots", "../utilities"], function (require, exports, tslib_1, React, merge_styles_1, style_utilities_1, utilities_1, slots_1, utilities_2) {
    ...
    function composed(baseComponentOrOptions, recompositionOptions) {
        ...
        if (typeof baseComponentOrOptions === 'function' && baseComponentOrOptions.__options) {
            ...
            options = (0, tslib_1.__assign)((0, tslib_1.__assign)((0, tslib_1.__assign)({}, baseComponentOptions_1), recompositionOptions), { slots: function (props) { return ((0, tslib_1.__assign)((0, tslib_1.__assign)({}, resolveSlots(baseComponentOptions_1.slots, props)), resolveSlots(recompositionSlots_1, props))); } });
        }
        else {
        ...
        var ResultComponent = function (componentProps) {
            ...
            if (stateReducer) {
                ...
                componentProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, componentProps), stateReducer(componentProps));
            }
            ...
            var viewProps = (0, tslib_1.__assign)((0, tslib_1.__assign)({}, componentProps), { styles: styles, tokens: tokens, _defaultStyles: displayName ? finalStyles : styles });
            if (!options.slots) {
        ...
        for (var _a = 0, allTokens_1 = allTokens; _a < allTokens_1.length; _a++) {
            ...
            if (currentTokens) {
                ...
                if (Array.isArray(currentTokens)) {
                    currentTokens = _resolveTokens.apply(void 0, (0, tslib_1.__spreadArray)([props, theme], currentTokens, false));
                }
