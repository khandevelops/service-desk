...
var FocusTrapZone = /*#__PURE__*/function (_React$Component) {
  ...
  function FocusTrapZone() {
    ...
    _this.handleRef = function (element) {
      ...
      (0, _reactComponentRef.handleRef)(_this.props.innerRef, element);
    };
    ...
    _this._releaseFocusTrapZone = function () {
      ...
      if (!ignoreExternalFocusing && _this._previouslyFocusedElementOutsideTrapZone && (
      // @ts-ignore
      _this._root.current.contains(activeElement) || activeElement === doc.body)) {
        _this._focusAsync(_this._previouslyFocusedElementOutsideTrapZone, {
          preventScroll: _this.props.preventScrollOnRestoreFocus
        });
      }
      ...
      if (!lastActiveFocusTrap) {
        ...
        var element = lastActiveFocusTrap._root.current;
        // aria hidden attributes are added to direct children of body. It can be the focusTrapZone root itself, or its parent
        while (element.parentElement && element.parentElement !== (doc == null ? void 0 : doc.body)) {
  ...
  _proto.componentWillUnmount = function componentWillUnmount() {
    ...
    var doc = (0, _focusUtilities.getDocument)(this._root.current);
    if (!this.props.disabled || this.props.forceFocusInsideTrapOnOutsideFocus ||
    // @ts-ignore
  ...
  _proto._focusAsync = function _focusAsync(element, options) {
    if (!this._isBumper(element)) {
      (0, _focusUtilities.focusAsync)(element, options);
    }
  };
