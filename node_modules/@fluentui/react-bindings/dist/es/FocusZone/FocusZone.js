...
import { getDocument as _getDocument } from '../utils/getDocument';
import { getWindow } from '../utils/getWindow';
import { findScrollableParent } from '../utils/findScrollableParent';
import { shouldWrapFocus as _shouldWrapFocus } from '../utils/shouldWrapFocus';
...
export var FocusZone = /*#__PURE__*/function (_React$Component) {
  ...
  function FocusZone(props) {
    ...
    _this.setRef = function (elem) {
      ...
      handleRef(_this.props.innerRef, elem);
  ...
  _proto.render = function render() {
    ...
    var unhandledProps = getUnhandledProps(_keys(FocusZone.propTypes), this.props);
