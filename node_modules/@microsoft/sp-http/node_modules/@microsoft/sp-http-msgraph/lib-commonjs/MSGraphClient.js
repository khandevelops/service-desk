...
var SPHttpMsGraphStrings_resx_1 = tslib_1.__importDefault(require("./SPHttpMsGraphStrings.resx"));
/**
...
var MSGraphClient = /** @class */ (function () {
    ...
    function MSGraphClient(serviceScope) {
        ...
        serviceScope.whenFinished(function () {
            ...
            if (!MSGraphClient._instance) {
                MSGraphClient._instance = _this._createGraphClientInstance(sp_http_base_1._AadTokenProviders.configurable);
            }
        });
    }
    /**
    ...
    MSGraphClient.prototype._createGraphClientInstance = function (tokenProvider) {
        ...
        if (!(MSGraphClient._window.MicrosoftGraph && MSGraphClient._window.MicrosoftGraph.Client)) {
            throw new Error(SPHttpMsGraphStrings_resx_1.default.graphClientInitializationError);
        }
        else {
