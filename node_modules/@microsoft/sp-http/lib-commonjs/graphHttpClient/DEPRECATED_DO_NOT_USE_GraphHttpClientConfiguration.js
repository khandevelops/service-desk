...
/**
 * Configuration for {@link _DEPRECATED_DO_NOT_USE_GraphHttpClient}.
 *
 * @remarks
...
var DEPRECATED_DO_NOT_USE_GraphHttpClientConfiguration = /** @class */ (function (_super) {
    tslib_1.__extends(DEPRECATED_DO_NOT_USE_GraphHttpClientConfiguration, _super);
    /**
     ...
     */
    function DEPRECATED_DO_NOT_USE_GraphHttpClientConfiguration(flags, overrideFlags) {
        return _super.call(this, flags, overrideFlags) || this;
    }
    return DEPRECATED_DO_NOT_USE_GraphHttpClientConfiguration;
}(sp_http_base_1.HttpClientConfiguration));
exports.default = DEPRECATED_DO_NOT_USE_GraphHttpClientConfiguration;
exports.predefinedConfigurations = {
    v1: new DEPRECATED_DO_NOT_USE_GraphHttpClientConfiguration(sp_http_base_1.HttpClient.configurations.v1)
};
//# sourceMappingURL=DEPRECATED_DO_NOT_USE_GraphHttpClientConfiguration.js.map