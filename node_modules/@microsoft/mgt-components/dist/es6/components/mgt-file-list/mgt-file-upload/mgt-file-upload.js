                    ...
                    if (driveItem !== null) {
                        ...
                        return new Promise((resolve) => __awaiter(this, void 0, void 0, function* () {
                            ...
                            function onOkDialogClick() {
                                ...
                                resolve([fileUploadDialogCheck.checked ? 1 : 0, 1 /* replace */]);
                            }
                            //Rename File
                            function onCancelDialogClick() {
                                fileUploadDialog.classList.remove('visible');
                                resolve([fileUploadDialogCheck.checked ? 1 : 0, 0 /* rename */]);
                            }
                            //Cancel File
                ...
                try {
                    if (!fileItem.completed) {
                        if (fileItem.conflictBehavior === null ||
                            fileItem.conflictBehavior === 1 /* replace */) {
                            graphQuery = `${this.getGrapQuery(fileItem.fullPath)}:/content`;
                        }
                        if (fileItem.conflictBehavior === 0 /* rename */) {
