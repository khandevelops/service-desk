...
let MgtPerson = MgtPerson_1 = class MgtPerson extends MgtTemplatedComponent {
    ...
    renderImage(personDetailsInternal, imageSrc) {
        const title = personDetailsInternal && this.personCardInteraction === PersonCardInteraction.none
        ...
        <div class="img-wrapper">
          <img alt=${personDetailsInternal.displayName} src=${imageSrc} @error=${() => (this._isInvalidImageSrc = true)} />
        </div>
      `;
        }
