...
let MgtPeoplePicker = class MgtPeoplePicker extends MgtTemplatedComponent {
    ...
    renderInput() {
        ...
        const inputAriaLabelText = `${this._currentSelectedUser !== undefined
    ...
    renderSelectedPeople(selectedPeople) {
       ...
       <div
        ...
        role="listbox"
        class="selected-list__options">${selectedPeople.slice(0, selectedPeople.length).map(person => html `
             <div
             role="option"
             tabindex="0"
    ...
    renderSearchResults(people) {
      ...
      <div
        ...
        aria-expanded="true"
        role="list"
        aria-label="people-picker-input input text ${this.userInput.length === 0 ? this.strings.inputPlaceholderText : this.userInput} ${this.strings.suggestedContacts} ${names}"
        @mouseenter=${this.handleMouseEnter}
        @mouseleave=${this.handleMouseLeave}>
         ${repeat(filteredPeople, person => person.id, person => {
            const listPersonClasses = {
                focused: this._isKeyboardFocus && this._arrowSelectionCount === 0 ? person.isFocused : '',
                'list-person': true
            };
            return html `
               <li
