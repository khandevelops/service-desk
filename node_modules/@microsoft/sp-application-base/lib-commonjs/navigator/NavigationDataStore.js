...
//
// TODO: remove this file (an .test.ts as well) once we graduate KS isDisableNavigationCacheKSActivated (1f9b5b68-e4fa-4ca9-94df-b97b1af022f4)
//
...
var NavigationDataStore = /** @class */ (function () {
    function NavigationDataStore(id, buildIdKey, buildId, executor, validator, refreshThresholdMs, maxStoreSize) {
        ...
        sp_core_library_1.Validate.isNotNullOrUndefined(executor, 'executor');
    ...
    NavigationDataStore._generateItemCacheKey = function () {
        return "spfx-ndsi-".concat(Date.now(), "-").concat(Math.floor(Math.random() * 1000));
    };
    ...
    NavigationDataStore.prototype._fetchData = function (url, props, cachedItem, // after removing the KS isDisableNavigationCacheKSActivated we can remove this parameter completely
    cachedItemIdx) {
        var _this = this;
...
exports.default = NavigationDataStore;
