...
var PlaceholderContent = /** @class */ (function () {
        ...
        if (!this._isDisposed) {
            if (this._disposeHandler) {
                try {
                    ...
                    sp_diagnostics_1._TraceLogger.logError(PlaceholderContent._logSource, new Error("The onDispose API threw an exception for placeholder '".concat(this._placeholder.name, "'. Error information is '").concat(error.message, "'")));
                }
            }
    ...
    PlaceholderContent._logSource = sp_diagnostics_1._LogSource.create('Placeholder');
