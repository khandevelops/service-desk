...
var _PreviewUtility = /** @class */ (function () {
    ...
    _PreviewUtility.normalizeWidth = function (width, isPublicImage) {
        ...
        return _PreviewUtility._getWidthByMeTACache(_PreviewUtility.scaleByPixelRatio(width), isPublicImage);
    };
    /**
    ...
    _PreviewUtility.scaleByPixelRatio = function (width) {
        if (width) {
            return Math.round(width * _PreviewUtility.getClampedDevicePixelRatio());
        }
        else {
            return width;
        }
     ...
     */
    _PreviewUtility.getClampedDevicePixelRatio = function () {
        var _a;
        var clamped = 1;
    ...
    _PreviewUtility.normalizeDimension = function (width, height, resolution) {
        if (!height && width) {
            ...
            width = Math.round(_PreviewUtility.scaleByPixelRatio(width));
            height = Math.round(_PreviewUtility.scaleByPixelRatio(height));
