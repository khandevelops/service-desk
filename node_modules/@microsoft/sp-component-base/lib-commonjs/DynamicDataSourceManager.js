...
var DynamicDataSourceManager = /** @class */ (function () {
    ...
    DynamicDataSourceManager.prototype._getPropertyValue = function (propertyId) {
        ...
        try {
            ...
            qosMonitor.writeSuccess(tslib_1.__assign(tslib_1.__assign({}, ((this._src && this._src.metadata) || {})), { sourceId: this._src && this._src.id, propertyValue: propertyValue, propertyId: propertyId }));
