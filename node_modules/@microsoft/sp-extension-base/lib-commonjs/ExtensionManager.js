...
var ExtensionStrings_resx_1 = tslib_1.__importDefault(require("./ExtensionStrings.resx"));
/**
...
var ExtensionManager = /** @class */ (function () {
     ...
     */
    ExtensionManager.prototype.createExtension = function (componentId, propertiesJson, contextCreator, additionalInitParameters) {
        var _this = this;
        ...
        try {
            ...
            var createPromise = sp_loader_1.SPComponentLoader.loadComponent(manifest)
                ...
                return extension
                    ._init(context_1, propertiesJson, additionalInitParameters)
                    .then(function () {
                    return extension;
                })
                    .catch(function (e) {
