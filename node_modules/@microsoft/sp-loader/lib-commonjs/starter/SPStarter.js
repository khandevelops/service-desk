...
exports._APP_WORKLOAD_QSP = exports._INCLUDE_APP_WORKLOAD = void 0;
...
var SPStarter = /** @class */ (function () {
    ...
    SPStarter.start = function (preloadedData, handleFailure, debugData, isFirstFlush) {
        ...
        return DebugManager_1.DebugManager.initialize(componentLoader, debugData)
            ...
            SPStarter._logDataInRealTime();
            return _this.handleError(error, Starter_resx_1.default.loaderUserFriendlyError, sp_telemetry_1._Telemetry.isInitialized ? 'ClientError' : 'ClientErrorBeforeTelemetry', correlationId, preloadedData);
        });
    };
    ...
    SPStarter._initializeTelemetry = function (preloadedData) {
        ...
        var workload = manifests[0].alias;
        if (!(0, killSwitches_1.overrideWorkloadKSActivated)() &&
            manifests[0].experimentalData &&
            manifests[0].experimentalData[exports._INCLUDE_APP_WORKLOAD]) {
            try {
        ...
        sp_telemetry_1._Telemetry.initialize(workload, spPageContextInfo, buildNumber, clientSideApplicationId, SPStarter._isConsoleLogEnabled(), listItemUniqueId);
