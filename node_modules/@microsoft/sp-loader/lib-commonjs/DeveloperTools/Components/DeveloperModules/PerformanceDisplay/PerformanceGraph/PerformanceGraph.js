...
var PerformanceGraphItem_1 = tslib_1.__importDefault(require("./PerformanceGraphItem/PerformanceGraphItem"));
var PerformanceGraph_module_scss_1 = tslib_1.__importDefault(require("./PerformanceGraph.module.scss"));
...
var PerformanceGraph = /** @class */ (function (_super) {
    tslib_1.__extends(PerformanceGraph, _super);
    ...
    PerformanceGraph.prototype.render = function () {
        ...
        var nameStyle = [PerformanceGraph_module_scss_1.default.tableRowPerfList, PerformanceGraph_module_scss_1.default.tableRowRightLight, PerformanceGraph_module_scss_1.default.tableRowName].join(' ');
