...
var TraceList = /** @class */ (function (_super) {
    ...
    function TraceList() {
        ...
        _this._handleButtonClick = function () {
            (0, CsvRenderer_1.triggerCsvDownload)(_this.props.allTraces);
        };
        return _this;
    }
    TraceList.prototype.render = function () {
        ...
        return (React.createElement("div", { className: TraceList_module_scss_1.default.container },
            React.createElement("button", { onClick: this._handleButtonClick }, TraceDisplay_resx_1.default.ExportCSVButtonLabel),
            React.createElement(TraceListHeader_1.default, { filters: this.props.filters }),
