...
var ErrorBuilder = /** @class */ (function () {
    ...
    ErrorBuilder.buildMissingPathDependencyError = function (manifest, dependencyName) {
        ...
        return this.buildErrorWithVerboseLog(SPLoaderError_1.SPLoaderErrorCode.missingPathDependencyError, undefined, true, telemetryConstants.loadComponentLogSource, undefined, dependencyName, manifest.id, manifest.alias, Object.keys(manifest.loaderConfig.scriptResources).join(Error_resx_1.default.listSeparator));
    };
    ErrorBuilder.buildLoadComponentDependencyFailoverPathError = function (manifest, dependencyName, failoverPath, error) {
        ...
        return this.buildErrorWithVerboseLog(SPLoaderError_1.SPLoaderErrorCode.loadComponentDependencyFailoverPathError, error, false, telemetryConstants.loadComponentLogSource, undefined, dependencyName, typeof failoverPath === 'object' ? failoverPath.path : failoverPath, manifest.id, manifest.alias, error.message);
    };
