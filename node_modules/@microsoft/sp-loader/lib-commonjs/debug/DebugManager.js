    ...
    DebugManager._getDebugScripts = function (componentLoader, resolve, registerAsNonDebug) {
        ...
        Promise.all([debugLoaderPromise, debugManifestsFilePromise])
            ...
            if (error instanceof Error) {
                (0, showDebugError_1.default)(error, DebugManager_resx_1.default.errorLoadingDebugScriptUnknown, DebugManager_resx_1.default.errorLoadingUnknownTitle).catch(console.error);
            }
            else {
