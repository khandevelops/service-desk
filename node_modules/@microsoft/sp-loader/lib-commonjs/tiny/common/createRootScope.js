...
function initializeGraphHttpClient(pageContext, spHttpClient, graphContext) {
    var _a, _b;
    var aadInstanceUrl = pageContext.aadInstanceUrl, aadSessionId = pageContext.aadSessionId, aadTenantId = pageContext.aadTenantId, aadUserId = pageContext.aadUserId, CorrelationId = pageContext.CorrelationId, env = pageContext.env, isAnonymousGuestUser = pageContext.isAnonymousGuestUser, isExternalGuestUser = pageContext.isExternalGuestUser, msGraphEndpointUrl = pageContext.msGraphEndpointUrl, IsMsalTokenProviderPopupEnabled = pageContext.IsMsalTokenProviderPopupEnabled, spfx3rdPartyServicePrincipalId = pageContext.spfx3rdPartyServicePrincipalId, spfx3rdPartyCustomServicePrincipalId = pageContext.spfx3rdPartyCustomServicePrincipalId, userPrincipalName = pageContext.userPrincipalName, webAbsoluteUrl = pageContext.webAbsoluteUrl, webServerRelativeUrl = pageContext.webServerRelativeUrl;
    ...
    if ((0, flights_1.isAPEXSpfxCustomAppPrincipalClientEnabled)() && spfx3rdPartyCustomServicePrincipalId) {
    ...
    if ((((0, flights_1.isOBOForAllTeamsScenariosEnabled)() && sp_core_library_1._BrowserUtilities.isTeamsHosted()) ||
        (!(0, killSwitches_1.useOBOInWebForSecureBrokerKSActivated)() && sp_core_library_1._BrowserUtilities.isUsingSecureBroker())
