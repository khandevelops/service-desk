...
var RequireLoader = /** @class */ (function () {
    ...
    RequireLoader.prototype._loadComponent = function (manifest, retryCount) {
        ...
        return this._configurator
            ...
            var requirejsError = e.requirejsError || e; // tslint:disable-line:no-any
            if (isScriptError) {
            ...
            if ((0, killSwitches_1.isDontLogRecursiveRetryKSActivated)() || !isRecursiveCatch) {
                if (!(0, killSwitches_1.traceRequireLoaderErrorKSActivated)()) {
                    console.error('Could not load ' + manifest.loaderConfig.entryModuleId + ' in require. Trying in system.js.', e);
                }
                if (manifest.isInternal) {
                    requireMonitor = new sp_telemetry_1._QosMonitor('TinyRequireLoader._loadComponent');
                }
            ...
            // Only use the fallback for third party components when RequireJS threw error other than scripterror
            if (manifest.isInternal || (!(0, killSwitches_1.isDontFallbackOnScriptFailureKSActivated)() && isScriptError)) {
                throw e;
            }
