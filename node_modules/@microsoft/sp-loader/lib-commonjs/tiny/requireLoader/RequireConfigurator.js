...
var RequireConfigurator = /** @class */ (function () {
    ...
    RequireConfigurator.prototype.configLoadComponent = function (manifest) {
        ...
        // But then we're not updating Require config right await, but waiting untill all component dependencies for A are loaded (see Promise.all below).
        ...
        //
        if (!(0, killSwitches_1.isUpdatePathsConfigNoWaitKSActivated)() && Object.keys(config.paths).length) {
            var pathsConfig = {
                paths: config.paths
            };
    ...
    RequireConfigurator.prototype._configurePathResource = function (name, resource, manifest, config, mapConfig) {
        ...
        if (existingNormalizedNameForAddress) {
            ...
            (0, loadScriptWithoutEval_1.loadScriptWithoutEval)(address);
            // TODO (1213908): Handle the subresource integrity
