...
var HttpClientHelper = /** @class */ (function () {
        ...
        return fetchProvider
            ...
            /* 401 */ requiredClaims &&
                ...
                return new Promise(function (resolve, reject) {
                    ...
                    return _this._getTeamsAuthToken(new URL(request.url).origin, [requiredClaims])
                        .then(function (token) {
    ...
    HttpClientHelper._getTeamsAuthToken = function (application, claims) {
        var _this = this;
        if (sp_core_library_1._BrowserUtilities.isUsingSecureBroker()) {
            return this._getBrokerClientChunk().then(function (brokerClient) {
                return brokerClient._BrokerClient.getAuthToken(application, claims);
            });
        }
        return new Promise(function (resolve, reject) {
            _this._getTeamsSDK()
