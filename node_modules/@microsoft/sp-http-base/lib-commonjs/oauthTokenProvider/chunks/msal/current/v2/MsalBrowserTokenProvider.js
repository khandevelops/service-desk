...
var MsalBrowserTokenProvider = /** @class */ (function () {
    ...
    MsalBrowserTokenProvider.prototype.getTokenData = function (resourceEndpoint, optionsOrUseCachedToken, skipLoggingAndDisableRedirects) {
        ...
        var _a = options.skipLoggingAndDisableRedirects, shouldNotLogOrRedirect = _a === void 0 ? false : _a, _b = options.useCachedToken, useCachedToken = _b === void 0 ? true : _b, claims = options.claims;
        this._shouldPrintDebugLogs = (0, MsalUtilities_1.shouldPrintMsalLogsToConsole)();
        var requestContext = {
    ...
    MsalBrowserTokenProvider.prototype._generateSilentRequest = function (requestContext) {
        var resourceEndpoint = requestContext.resourceEndpoint, claims = requestContext.claims, correlationId = requestContext.telemetryData.CorrelationId;
        var silentRequestData = tslib_1.__assign({ account: this._getCurrentAccount(), authority: this._getAuthority(), correlationId: correlationId, scopes: this._getScopes(resourceEndpoint) }, (claims
            ? {
                claims: claims
            }
            : {}));
    ...
    MsalBrowserTokenProvider.prototype._generateSsoSilentRequest = function (requestContext) {
        ...
        if (!(0, AadKillSwitches_1.isMsalBrowserRetryAndSsoSilentImprovementsKsActivated)()) {
            ssoSilentRequestData = tslib_1.__assign({ authority: this._getAuthority(), correlationId: correlationId, scopes: this._getScopes(resourceEndpoint) }, (claims
                ? {
                    claims: claims
                }
                : {}));
            ...
            ssoSilentRequestData = tslib_1.__assign({ authority: this._getAuthority(), correlationId: correlationId, loginHint: this._getUPN(), scopes: this._getScopes(resourceEndpoint), sid: this._getSessionId() }, (claims
                ? {
                    claims: claims
                }
                : {}));
    ...
    MsalBrowserTokenProvider.prototype._generatePopupRequest = function (requestContext) {
        var resourceEndpoint = requestContext.resourceEndpoint, claims = requestContext.claims, correlationId = requestContext.telemetryData.CorrelationId;
        var popupRequestData = tslib_1.__assign({ account: this._getCurrentAccount(), authority: this._getAuthority(), correlationId: correlationId, scopes: this._getScopes(resourceEndpoint) }, (claims
            ? {
                claims: claims
            }
            : {}));
