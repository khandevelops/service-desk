...
var PropertyPaneFooter = /** @class */ (function (_super) {
    ...
    PropertyPaneFooter.prototype._renderCommandButtons = function () {
        ...
        return (this.props.isReactive === false && (React.createElement("div", { className: this.props.numberOfPages > 1 ? PropertyPaneFooter_module_scss_1.default.propertyPaneCommandButtonsBox : undefined },
            React.createElement(office_ui_fabric_react_bundle_1.PrimaryButton, { "data-automation-id": 'propertyPaneApplyButton', disabled: !this.props.isSaveButtonEnabled, onClick: this.props.onSaveClick, ariaDescription: Strings_resx_1.default.ApplyButtonAriaDescription }, Strings_resx_1.default.Save)))); // tslint:disable-line:no-any
    };
