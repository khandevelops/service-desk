...
var BOT_ACE_WP_MANIFEST_ID = 'a922c05b-766f-4409-9985-a4806230ad38';
var OLD_IMAGE_WP_MANIFEST_ID = 'd1d91016-032f-456d-98a4-721247c305e8';
var NEW_IMAGE_WP_MANIFEST_ID = 'fe2f2812-4df0-42c7-ae2e-2db57e092751';
/**
...
var ClientSideWebPartManager = /** @class */ (function () {
    ...
    ClientSideWebPartManager.prototype.loadWebPart = function (webPartManagerContext) {
        ...
        try {
            ...
            var isIsolatedACEWPManifest = context_1.manifest.id === ISOLATED_ACE_WP_MANIFEST_ID;
            var isACE = context_1.manifest.componentType === 'AdaptiveCardExtension' ||
                ((_a = context_1.manifest.experimentalData) === null || _a === void 0 ? void 0 : _a.ACE) ||
                isACEWPManifest ||
                isIsolatedACEWPManifest;
            var isBotACE = (0, Flights_1.isBotDrivenACEEnabled)() && !!((_b = context_1.manifest.properties) === null || _b === void 0 ? void 0 : _b['botId']); // tslint:disable-line:no-string-literal
            var isIsolated_1 = ClientSideWebPartManager._isLoadingIsolatedWebPart(context_1, this._pageContext.site.absoluteUrl);
            if (isIsolated_1 && !isACE) {
            ...
            if (isACE) {
                ...
                if ((!(0, KillSwitches_1.isIsolatedAdaptiveCardExtensionWebPropertyPaneWorkAroundKSActivated)() &&
                    ...
                    context_1.displayMode === sp_core_library_1.DisplayMode.Edit) ||
                    (!isACEWPManifest && !isIsolated_1)) {
                    if (!(0, KillSwitches_1.isBotDrivenACEManifestLoadLogicKSActivated)() && isBotACE) {
                        context_1.manifest = sp_loader_1._ManifestStore.instance.tryGetManifest(BOT_ACE_WP_MANIFEST_ID);
                    }
                    else {
                ...
                else if ((0, Flights_1.isIsolatedAdaptiveCardExtensionWebEnabled)() && !isIsolatedACEWPManifest && isIsolated_1) {
                    // TODO: ensure Isolated ACE WP manifest is preloaded
                    if (!(0, KillSwitches_1.isBotDrivenACEManifestLoadLogicKSActivated)() && isBotACE) {
                        context_1.manifest = sp_loader_1._ManifestStore.instance.tryGetManifest(BOT_ACE_WP_MANIFEST_ID);
                    }
                    else {
                        context_1.manifest = sp_loader_1._ManifestStore.instance.tryGetManifest(ISOLATED_ACE_WP_MANIFEST_ID);
                    }
                }
                else if ((0, KillSwitches_1.isBotDrivenACEManifestLoadLogicKSActivated)() && isBotACE) {
                    context_1.manifest = sp_loader_1._ManifestStore.instance.tryGetManifest(BOT_ACE_WP_MANIFEST_ID);
                }
                // @todo [VSO:WEX!#1076592] Clean up temporary ACE WP upgrade code
                if (context_1.webPartData) {
                    context_1.webPartData = tslib_1.__assign(tslib_1.__assign({}, context_1.webPartData), (_c = context_1.webPartData.properties) === null || _c === void 0 ? void 0 : _c['aceData']); // tslint:disable-line:no-string-literal
                }
                if (context_1.displayMode === sp_core_library_1.DisplayMode.Edit &&
                    !(0, KillSwitches_1.isIsolatedAdaptiveCardExtensionIframedPropertyPaneKSActivated)() &&
                    isIsolated_1 &&
                    context_1.manifest.id === ISOLATED_ACE_WP_MANIFEST_ID) {
                    // tslint:disable-next-line:no-floating-promises
                    this._loadIsolatedWebPart(context_1, true);
                }
            }
            context_1.webPartTag = ClientSideWebPartManager.createWebPartTag(context_1.manifest, context_1.instanceId);
            if (context_1.domElement && context_1.domElement.setAttribute) {
    ...
    ClientSideWebPartManager.prototype.fetchWebPartManifests = function () {
        var _this = this;
        var meeDashboardEnabled = (0, Flights_1.isMeeDashboardEnabled)();
        var callGetClientSideComponentsByComponentType = (0, Flights_1.isCallGetClientSideComponentsByComponentTypeEnabled)();
        var shouldFetchACEs = (!callGetClientSideComponentsByComponentType ||
            (!(0, Flights_1.isOptionalSupportedHostsFilteringEnabled)() && !(0, KillSwitches_1.fixACERequiringWPinSupportedHostsKSActivated)())) &&
            meeDashboardEnabled;
        var linkToVCInDashboardToolboxEnabled = (0, Flights_1.isLinkToVcInDashboardToolboxFlightEnabled)();
        if (shouldFetchACEs) {
        ...
        if (!this._toolboxManifestsPromise) {
            ...
            if (callGetClientSideComponentsByComponentType && meeDashboardEnabled) {
                if ((0, Flights_1.isOptionalSupportedHostsFilteringEnabled)()) {
                    if (linkToVCInDashboardToolboxEnabled) {
                        ...
                        endpoint = "_api/web/GetClientSideComponentsByComponentType(componentTypesString='".concat(Enums_1.SPClientSideComponentType.WebPart, ",").concat(Enums_1.SPClientSideComponentType.AdaptiveCardExtension, "')");
                    }
                }
                else if (!(0, KillSwitches_1.fixACERequiringWPinSupportedHostsKSActivated)()) {
                    ...
                    endpoint = "_api/web/GetClientSideComponentsByComponentType(componentTypesString='".concat(Enums_1.SPClientSideComponentType.WebPart, ",").concat(Enums_1.SPClientSideComponentType.AdaptiveCardExtension, "',supportedHostTypeValue=").concat(Enums_1.SupportedHostType.SharePointWebPart, ")");
                }
            }
            else {
            ...
            this._host.serviceScope.whenFinished(function () {
                ...
                _this._toolboxManifestsPromise = _this._fetchManifestsWithCache(httpClient, requestUrl_1)
                    ...
                    var manifests = value.value.map(function (manifestObject) {
                        ...
                        if (linkToVCInDashboardToolboxEnabled && manifestObject.ManifestActivatedTime) {
        ...
        if (shouldFetchACEs) {
            return Promise.all([this._toolboxACEManifestsPromise, this._toolboxManifestsPromise]).then(function () { return undefined; });
        }
    ...
    ClientSideWebPartManager.prototype._fetchAdaptiveCardExtensionManifests = function () {
        ...
        var endpoint;
        if ((0, Flights_1.isCallGetClientSideComponentsByComponentTypeEnabled)()) {
            if (linkToVCInDashboardToolboxEnabled) {
                endpoint = "_api/web/GetClientSideComponentsByComponentType(componentTypesString='".concat(Enums_1.SPClientSideComponentType.AdaptiveCardExtension, "',supportedHostTypeValue=").concat(Enums_1.SupportedHostType.Dashboard, ", includeManifestActivatedTime=true)");
            }
            else {
                endpoint = "_api/web/GetClientSideComponentsByComponentType(componentTypesString='".concat(Enums_1.SPClientSideComponentType.AdaptiveCardExtension, "',supportedHostTypeValue=").concat(Enums_1.SupportedHostType.Dashboard, ")");
            }
        }
        else {
    ...
    ClientSideWebPartManager.prototype._swapManifestForWebparts = function (context) {
        if ((0, Flights_1.isImageRefactorFlightEnabled)() && context.manifest.id === OLD_IMAGE_WP_MANIFEST_ID) {
            // get the manifest for the v. 2 of the webpart
            var manifestCandidate = sp_loader_1._ManifestStore.instance.tryGetManifest(NEW_IMAGE_WP_MANIFEST_ID);
            // replace the manifest in context if we have a valid manifest, else keep old manifest
            context.manifest = manifestCandidate
                ? manifestCandidate // tslint:disable-line:no-any
                : context.manifest;
        }
    };
    /**
